...
lblInfo = Label(Tops, font=('helvetica', 50, 'bold'), text="RESTAURANT TKINTER", fg="Black", bd=10, anchor='w')
...
def Ref():
    ...
    try:
        with connection.cursor() as cursor:
            ...
            sql = "INSERT INTO `billDetails` (`ref` , `serv`, `tax`, `tot`) VALUES ( %s, %s , %s , %s)"
            cursor.execute(sql, (ref, serv, tax, tot, ))
...
btnTotal = Button(f1, padx=16, pady=8, bd=16, fg="Red", font=('arial', 16, 'bold'), width=10, text="Total", bg="Black",
                  command=Ref).grid(row=7, column=1)

btnReset = Button(f1, padx=16, pady=8, bd=16, fg="Red", font=('arial', 16, 'bold'), width=10, text="Reset", bg="Black",
                  command=Reset).grid(row=7, column=2)

btnExit = Button(f1, padx=16, pady=8, bd=16, fg="Red", font=('arial', 16, 'bold'), width=10, text="Exit", bg="Black",
